...
let data: any = {
  defaultData: {
    ...
    OrderDetails: [
      { orderNumber: 1, line: 1, product: 1, price: 0.7, quantity: 1, id: 11 },
      { orderNumber: 2, line: 2, product: 2, price: 0.44, quantity: 2, id: 19 },
      { orderNumber: 3, line: 3, product: 3, price: 0.26, quantity: 3, id: 36 },
      { orderNumber: 4, line: 4, product: 4, price: 0.02, quantity: 4, id: 18 },
      { orderNumber: 5, line: 5, product: 5, price: 0.11, quantity: 5, id: 64 },
    ],
    Payments: [
      {
        orderNumber: 1,
